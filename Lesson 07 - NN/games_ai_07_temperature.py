# -*- coding: utf-8 -*-
"""Machine Learning #03 - Temperature

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UVq3FYqgjzEjhwfMHkA_Piy4p-FqG-oa?hl=en
...
The code uses TensorFlow, Keras, NumPy, and a plotting library.
"""
...
# to ensure reproducible results (good for testing, not good for production)
# RANDOM_SEED: int = 42
...
# generate train data
celsius: np.ndarray = np.array([-30, -25, -10, 0, 10, 20, 35, 50, 70, 100], dtype=np.float32)
...
fahrenheit: list[np.float32] = [t * 1.8 + 32 for t in celsius]
print(fahrenheit)

# needs to be a numpy array
fahrenheit: np.ndarray = np.array(fahrenheit, dtype=np.float32)
...
w: float = 0.981253
b: float = 0
celsius_value: float = 20.0
y: float = celsius_value * w + b
loss: float = abs(68 - y)
print(f"fahrenheit = {y}")
print(f"loss = {loss}")
